...
- **PMD** — Added configurable `Boolean` wrapper handling to
  `BooleanGetMethodName`, allowing `java.lang.Boolean` to be excluded
  while preserving primitive `boolean` checks.
  [PR #6962](https://github.com/pmd/pmd/pull/6962)
